    ...
    return (
        <View className="flex-1 bg-gray-100 justify-center items-center">
            <View className="bg-white justify-center items-center m-h-150 px-5 rounded-xl border border-gray-400 pb-4">
                ...
                <TouchableOpacity className="bg-gray-200 border border-l-gray-500 h-8 w-[50px] items-center justify-center" activeOpacity={0.5} onPress={handleClick}><Text>Login</Text></TouchableOpacity>
            </View>
        </View>
    )
}